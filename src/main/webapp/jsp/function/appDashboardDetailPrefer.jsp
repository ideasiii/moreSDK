		...
		<form id="searchForm" >
			<div>
				...
				<div class="date date1 fl">
					...
					<a href="javascript:;" onclick='searchDate("<s:url action="appDashboardDetailPrefer" namespace="/function"/>");'>
		...
		<div class="col-md-12 d_shadow" style="margin-top: 10px;">
			...
			<div class="panel-body">
				...
				<ul class="nav nav-tabs">
					<li><a href="javascript:;" onclick='changeTab("<s:url action="appDashboardDetail" namespace="/function"/>")'>APP當前分析</a>
					</li>
					<li><a href="javascript:;" onclick='changeTab("<s:url action="appDashboardDetailCross" namespace="/function"/>")'>APP交叉分析</a></li>
					<li class="active"><a href="javascript:;" data-toggle="tab">APP偏好分析</a></li>
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade in active" id="messages">
						<div class="row">
							<div class="col-sm-3">
								<div style="padding: 10px 0px;">
									分類 <s:select id="mapCategory"  list="categoryList"></s:select>
							...
							<div class="col-sm-3">
								<div style="padding: 10px 0px;">
									<button type="button" class="btn btn-primary" onclick="getPreferMapData();">查詢</button>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12">
								<div class="well">
									<h4>App 月使用者出沒位置</h4>
									<div style="width: 100%;height: 500px;" id="preferMap">
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-sm-2">
								<div style="padding: 10px 0px;">
									<button type="button" class="btn btn-primary" onclick="getCategoryPieChartByCondition();">查詢</button>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="well">
									<h4>App 使用者出沒位置偏好比例</h4>
									<p>
										<span id="categoryPieConditionChart"></span>
									</p>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-sm-3">
								<div style="padding: 10px 0px;">
									<button type="button" class="btn btn-primary" onclick="getLocationCrossPieChart();">查詢</button>
								</div>
							</div>
							<div class="col-sm-6">
							</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="well">
									<h4>App <s:property value='endDate.split("-")[1]'/> 月使用者出沒位置偏好比例交叉分析</h4>
									<p>
										<span id="thisCategoryLocationCrossPieChart"></span>
									</p>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="well">
									<h4>App <s:property value='startDate.split("-")[1]'/> 月使用者出沒位置偏好比例交叉分析</h4>
									<p>
										<span id="preCategoryLocationCrossPieChart"></span>
									</p>
								</div>
							</div>
						</div>
