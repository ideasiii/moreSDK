...
<div class="panel panel-default">
	<div class="panel-heading">
		<a href="<s:url action="appDashboard" namespace="/function"/>">
			<button type="button" class="btn btn-primary">返回上一頁</button>
		</a>
	</div>
	<div class="panel-body">
		<form id="searchForm" >
			<div>
				<div class="date date1 fl" id="date">
					<input type="text" class="date-check form-control" placeholder="date" name="startDate" id="startDate" value='<s:property value="startDate"/>' readonly="readonly">
					
				</div>
				<div class="date date1 fl">
					<input type="hidden" name="app.appId" id="appId">
					<a href="javascript:;" onclick='searchDate("<s:url action="appDashboardDetail" namespace="/function"/>");'>
		...
		<div class="col-md-12 d_shadow" style="margin-top: 10px;">
			...
			<div class="panel-body">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="javascript:;" data-toggle="tab">APP當前分析</a>
					</li>
								...
								<div style="text-align: center;">
									<div style="display: inline;">
										<ul style="display: inline-block;">
											<li style="list-style: url(<s:property value="contextPath"/>/images/map/morning.png);">早</li>
										</ul>
									</div>
									<div style="display: inline">
										<ul style="display: inline-block;">
											<li style="list-style: url(<s:property value="contextPath"/>/images/map/noon.png);">中</li>
										</ul>
									</div>
									<div style="display: inline">
										<ul style="display: inline-block;">
											<li style="list-style: url(<s:property value="contextPath"/>/images/map/night.png);">晚</li>
										</ul>
									</div>
									<div style="display: inline">
										<ul style="display: inline-block;">
											<li style="list-style: url(<s:property value="contextPath"/>/images/map/mid.png); ">半夜</li>
										</ul>
									</div>
								</div>
